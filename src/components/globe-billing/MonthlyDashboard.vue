...
export default {
  ...
  data() {
    ...
    const computeList = [ 'Amazon Elastic Compute Cloud',
    ...
    const [ computeDR,
            computeDS,
            computeTotal,
            cNoData ] = genServices('TotalServicePerMonth', this.$props.cdata, computeList);

    const storageList = [ 'Amazon Simple Storage Service',
                          'Cloud Storage' ];
    const [ storageDR,
            storageDS,
            storageTotal,
            sNoData ] = genServices('TotalServicePerMonth', this.$props.cdata, storageList);

    const dbList = [  'Amazon Relational Database Service',
                      'Cloud SQL',
                      'Firebase Realtime Database' ];
    const [ databaseDR,
            databaseDS,
            databaseTotal,
            dbNoData ] = genServices('TotalServicePerMonth', this.$props.cdata, dbList);
