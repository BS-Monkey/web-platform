  ...
  <div>
    ...
    :selected="tabIndex">
      ...
      <tab name="Access">
        ...
        <p>
          2. Set the server authentication mode to "SQL Server and Windows Authentication Mode" in the Microsoft SQL Management Studio.
        </p>
        <p>
          3. Run the following T-SQL to create telegraf user on your SQL servers.  The account needs VIEW SERVER STATE and VIEW ANY DEFINITION permissions.
        </p>
        <p v-if="editing">
