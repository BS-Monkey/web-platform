              ...
              <pre id="jsonCode" class="tag primary highlight code">
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            >
              <button @click="copyFunction()" id="button"
              >
                <i class="fas fa-copy"></i>
              </button>
              <pre id="jsonCode" class="tag primary highlight code">
              ...
              <pre class="tag primary highlight code" id="jsonCode">
{
    ...
    "Statement": [
        ...
        },
        {
          ...
          <li>
            Give the policy a <span class="italics">Name</span> called <copy class="tag primary highlight">cmi-management</copy>
          ...
          <li>
            ...
            Search for the <span class="italics">cmi-management</span> policy you just created and
        ...
        <div class="text-right">
          ...
          &nbsp;
          <button class="button default outline" @click="gotoTab(2)" name="deploy">Next: Deploy</button>
        </div>
      </tab>
