  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="csx">
          <date-picker id="datepick"  input-class="datetime-picker" type="datetime" v-model="chartPeriod" format="YYYY-MM-DD HH:mm" placeholder="Select time Period" range></date-picker>
        </div>
        <div class="csx">
    ...
    <div id="DefaultChart">
        <div v-if="this.chartObject && Object.keys(this.chartObject).length > 0">
          <DefaultIntegrationDashboard :cdata="this.chartObject" :initOptions="this.initOptions" autoresize :key="this.keycount" msg="Welcome to Default Dashboard"/> 
        </div>
        <div v-else>
