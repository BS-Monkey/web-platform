    ...
    <div class="row">
      <div class="clg12 cxl8">
        ...
        <form @submit.prevent>
          ...
          <h2>Test Outputs</h2>
          <p>
            Send a sample alert to test you all your outputs.
          </p>
          <div class="row">
            <div class="clg3 cmd4 csm6 cxs12">
            ...
            <div class="clg4 cmd6 csm6 cxs12">
              <button class="button default outline" type="button" @click="testOutputs()">
          ...
          <div class="row">
            ...
            <div class="cmd6 csm6 cxs12">
              <button class="button outline danger" type="button" @click="deleteOpen = !deleteOpen">
          ...
          <div class="text-right">
            <router-link to="/pipelines" class="button link default">
              Cancel
            </router-link>
            &nbsp;
            <button
...
@Component
export default class PipelineSettings extends Vue {
  /* Variables */
  @Prop()
  private id: string;
  ...
  @Watch('currentOrg')
  private updateSelected(org: any, oldOrg: any) {
    this.getPipeline();
  }


  /* Methods */
  private getPipeline(): void {
    API.Pipeline.get()
      .then((response) => {
        this.pipelines = response;
        this.pipelines.forEach((pipeline: Pipeline) => {
  ...
  private deletePipeline(): void {
    API.Pipeline.delete(this.pipeline.id);
  }
