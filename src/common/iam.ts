...
export default class Iam {
  ...
  public static async validSession(refresh: boolean = false): Promise<string> {
    ...
    try {
      ...
      // TODO: remove on full switchover to v2/cognito
      return AuthLegacy.validSession();
    }
  }
  ...
  public static checkAuthz(requiredScope: string[], organization?: Organization|any): boolean {
